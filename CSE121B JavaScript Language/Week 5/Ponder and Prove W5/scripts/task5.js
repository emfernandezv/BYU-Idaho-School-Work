...
currentDay = NewCurrentDate.getDay();
...
function output(array){
    const html = array.map(
        (arr) => `<article>
        <h3>${arr.templeName}</h3>
        <h4>${arr.location}</h4>
        <h4>${arr.dedicated}</h4>
        <img src='${arr.imageUrl}' alt='${arr.templeName}'>
        </article>`
      );
...
function sortBy(){
    reset();
    let value = document.getElementById("temples").value;
